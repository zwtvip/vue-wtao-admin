 ...
 * @param treeData
 */
export function getTreeKeys(treeData: TreeDataItem[]): (string | number)[] {
  return treeToList(treeData).map((item) => item.key)
}
 ...
 * @param treeData
 */
export function getDeepList(deepList: (string | number)[], treeData: TreeDataItem[]): (string | number)[] {
 ...
 * @param direction
 */
export function handleLeftTreeData(data: TreeDataItem[], targetKeys: (string | number)[], direction = 'right'): TreeDataItem[] {
  data.forEach((item) => {
    if (direction === 'right') {
 ...
 * @param direction
 */
export function handleRightTreeData(data: TreeDataItem[], targetKeys: (string | number)[], direction = 'right'): TreeDataItem[] {
