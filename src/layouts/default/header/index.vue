<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-action`">
      ...
      <AppSizePicker v-if="sizeSetting.showPicker" :showText="false" :class="`${prefixCls}-action__item`" />
...
import { AppLogo, AppSearch, AppLocalePicker, AppSizePicker } from '@/components/Application'
